# Generated by Powerlevel10k configuration wizard on 2023-07-28 at 16:25 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_CHANGED_ICON='\uf055 '
  ...
  function my_git_formatter() {
   ...
   # local      clean='%99F' # black foreground
   # local   modified='%33F' # black foreground
   ...
   # local conflicted='%1F' # red foreground
    ...
    if [[ -n $VCS_STATUS_TAG
      ...
      res+="${meta}${clean}${(g::)POWERLEVEL9K_VCS_TAG_ICON}${clean}${tag//\%/%%}"
    fi
    ...
    (( VCS_STATUS_NUM_UNSTAGED   )) && res+=" ${modified}${(g::)POWERLEVEL9K_VCS_CHANGED_ICON}${VCS_STATUS_NUM_UNSTAGED}"
